...
- Яндекс Дзен: обязательно заголовок (до 60 символов) + лид-абзац (1-2 предл.) + основной текст. Дзен хорошо индексируется Яндексом — SEO обязателен.
- LinkedIn: профессиональный тон, конкретные бизнес-результаты, личный инсайт эксперта. Первая строка = хук до кнопки "ещё".
