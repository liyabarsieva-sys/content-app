          ...
          <div>
            <div style={{ background: S.bg2, border: `1px solid ${S.border}`, borderRadius: 14, padding: 22, marginBottom: 16 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                <Field label="Эксперт / компания">
                  <input style={inputStyle} placeholder="Сервис ФиксПК" value={expert} onChange={e => setExpert(e.target.value)} />
                </Field>
                <Field label="Сфера">
                  <input style={inputStyle} placeholder="Ремонт ноутбуков" value={niche} onChange={e => setNiche(e.target.value)} />
                </Field>
              </div>
              <Field label="Аудитория">
                <input style={inputStyle} placeholder="Жители города, владельцы ноутбуков" value={audience} onChange={e => setAudience(e.target.value)} />
              </Field>
        ...
        {step === 2 && (
          <div>
            <div style={{ background: S.bg2, border: `1px solid ${S.border}`, borderRadius: 14, padding: 22, marginBottom: 16 }}>
              ...
              <Field label="Что обязательно отразить">
