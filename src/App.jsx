...
Требования по объёму и стилю — это ЖЁСТКИЕ ЛИМИТЫ, не рекомендации. Считай слова перед отправкой:
- Telegram: МИНИМУМ 170 слов, МАКСИМУМ 200. Структурированный текст с абзацами. Первые 2 строки — самые важные (превью в ленте). Без хэштегов. Вопрос или призыв в конце.
- ВКонтакте: МИНИМУМ 140 слов, МАКСИМУМ 180. Первый абзац решает всё — он виден до "читать далее". В конце 3-4 хэштега.
- Facebook: МИНИМУМ 140 слов, МАКСИМУМ 165. Начни с личной истории или провокационного вопроса. Без хэштегов. Заканчивай вопросом для дискуссии.
- Threads: МИНИМУМ 60 слов, МАКСИМУМ 80. Цепляющий хук в первых 2 строках. Без хэштегов.
- Instagram: МИНИМУМ 100 слов, МАКСИМУМ 120. Ключевое слово в первом предложении (SEO). В конце 5 хэштегов.
